    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Toast.makeText(HotActivity.this, adapterView.getItemAtPosition(i) + " 클릭", Toast.LENGTH_SHORT).show();
        ...
        btn_new.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(HotActivity.this, WriteActivity.class);
                intent.putExtra("userid", userid);
                startActivity(intent);
            }
        });
    ...
    class GetBoard extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                ArrayAdapter arrayAdapter = new ArrayAdapter<String>(HotActivity.this, android.R.layout.simple_list_item_1, titleList);
